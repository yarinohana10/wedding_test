...
const EventDetailsWithRSVP: React.FC<EventDetailsWithRSVPProps> = ({ 
  ...
  const form = useForm<FormValues>({
    defaultValues: {
      ...
      attending: existingGuest?.status === 'אישר הגעה' ? 'yes' : existingGuest?.status === 'לא מגיע' ? 'no' : '',
  ...
  const onSubmit = async (data: FormValues) => {
    ...
    const guestData = {
      ...
      guests: data.guests === 'custom' ? Number(data.customGuests) : Number(data.guests),
      ...
      <div className="mt-12 border-t pt-8 text-right">
        <div className="text-center mb-6">
          <div className="divider-heart mb-4">
            <Heart className="text-wedding-primary mx-auto" size={24} fill="currentColor" />
          </div>
        ...
        {!showForm ? (
          <div className="max-w-md mx-auto">
            <div className="mb-8 text-center">
              <p className="mb-4">הזן את מספר הטלפון שלך כדי לעדכן את סטטוס ההשתתפות שלך:</p>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="ישראל ישראלי" {...field} className="text-right" />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="0501234567" {...field} className="text-right" />
                      </FormControl>
                      <FormDescription>
